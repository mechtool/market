...
export class AppPage {
  ...
  getModalRegisterOrganizationElement(): ElementFinder {
    return element(by.cssContainingText('market-requisites-checker', 'Регистрация новой организации'));
  }

  getModalRegisterOrganizationINN(): ElementFinder {
    return element(by.css('market-requisites-checker #formINN'));
  }

  getModalRegisterOrganizationBtn(): ElementFinder {
    return element(by.css('market-requisites-checker button'));
  }
