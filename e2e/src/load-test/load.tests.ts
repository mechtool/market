...
export function authorizedUserAddsProductsToCartAndPacesOrder() {
  ...
  it('Шаг 4: Пользователь переходит в произвольно выбранный продукт из найденных и проверяет наличии в нем торговых предложений',
    async() => {
...
export function unauthorizedUserSearches() {
  ...
  it('Шаг 3: Пользователь переходит в произвольно выбранный продукт из найденных и проверяет наличии в нем торговых предложений',
    async() => {
      console.log('Шаг 3: Начал выполнение');
      const time1 = Date.now();
  ...
  it(`Шаг 6: Пользователь переходит в произвольно выбранный продукт из найденных и проверяет наличии в нем торговых предложений`,
    async() => {
      console.log('Шаг 6: Начал выполнение');
      const time1 = Date.now();
