...
@Component({
  ...
  styleUrls: ['./feedback.component.scss', './feedback.component-577.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class FeedbackComponent {
  constructor(private _modalService: NzModalService, private _viewContainerRef: ViewContainerRef) {}
